...
if __name__ == '__main__':
  x = 'PROGRAMMING in a real-time environment can be challenging even for experienced programmers. This appendix is intended to illustrate some of the common problems  that are encountered in this environment, and present practical strategies for avoiding them.'
  res=translate(x)
  print(res)