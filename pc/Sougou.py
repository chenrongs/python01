...
class sogouIndex:
    ...
    def settings(self):
        ...
        if dataType == 'pc' or dataType == 'PC':
            self.params['dataType'] = pc
        elif dataType == 'all' or dataType == 'ALL':
            self.params['dataType'] = all
        elif dataType == 'wap' or dataType == 'WAP':
            self.params['dataType'] = wap
    ...
    def prettyPrint(self):
        ...
        if not (
                self.kwdName and self.avgPv and self.ratioMonth and self.ratioChain and self.avgWapPv and self.ratioWapChain and self.ratioWapMonth):
